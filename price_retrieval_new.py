#!/Users/danielbanh/Projects/Algo/env/bin/python
# -*- coding: utf-8 -*-

# price_retrieval_new.py
...
def get_daily_historic_data_yahoo(
    ...
    end_date: End date in (YYY, M, D) format
    """
    ...
    alpha_url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED"
    alpha_url += "&symbol=%s&outputsize=full&apikey=83L2I5WQUU7BYYUB&datatype=csv"
    alpha_url = alpha_url % ticker_tup

    # Try connecting to Yahoo Finance and obtaining the data
    # On failure, print an error message.
    try:
        yf_data = requests.get(alpha_url).text.split("\n")[2:-1]
        prices = []
        for y in yf_data:
            p = y.strip().split(',')
            prices.append(
